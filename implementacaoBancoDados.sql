-- Active: 1691955172011@@192.168.0.4@5432@dados_estacao
...
ALTER DATABASE dados_estacao SET datestyle TO ISO, DMY;

-- ********************** Schema tabelas_horarias **********************

create schema tabelas_horarias;

DROP SCHEMA tabelas_horarias cascade;
...
select * from "tabelas_horarias"."16-08-2023" order by codigo desc;

select * from "tabelas_horarias"."17-11-2022" order by codigo desc;
